...
class ChildCategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.child-category.create', compact('categories', 'subCategory'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $subCategories = SubCategory::where('category_id', $childCategory->category_id)->get(); //dd($subCategories)
