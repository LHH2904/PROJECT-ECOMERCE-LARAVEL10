            ...
            <div class="row">
                                            ...
                                            <td class="wsus__pro_select">
                                                <form class="d-flex justify-content-evenly">
                                                    ...
                                                    <input class="product-qty" data-rowid="{{ $item->rowId }}"
                                                        ...
                                                        value="{{ $item->qty }}"
                                                        style="width: 40px; height:38px; padding-left:12px" readonly />
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <p>discount(-): <span id="discount">{{ $settings->currency_icon }}{{ getCartDiscount() }}</span>
                        </p>
                        ...
                        <a class="common_btn mt-1 w-100 text-center" href="{{ route('home') }}"><i
                                class="fab fa-shopify"></i> Continue shop</a>
                    </div>
                </div>
            </div>
        </div>
